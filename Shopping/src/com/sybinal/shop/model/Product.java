...
public class Product {
	...
	public String toString() {
		return "Product [id=" + id + ", name=" + name + ", categoryId=" + categoryId + ", generalExplain="
				+ generalExplain + ", discount=" + discount + ", shopPrice=" + shopPrice + ", price=" + price
				+ ", externalId=" + externalId + ", quantity=" + quantity + ", hot=" + hot + ", productStatus="
				+ productStatus + ", inventoryFlag=" + inventoryFlag + ", defaultImg=" + defaultImg + ", updateTime="
				+ updateTime + ", updateUserId=" + updateUserId + ", createTime=" + createTime + ", createUserId="
				+ createUserId + ", explains=" + explains + ", updateTimeFrom=" + updateTimeFrom + ", updateTimeTo="
				+ updateTimeTo + ", categoryName=" + categoryName + ", updateUserName=" + updateUserName
	...
	private Integer pUpdateUserId;

	private Date pCreateTime;

	private Integer pCreateUserId;

	private String pOriginArea;

	private String pEnglishShort;

	private String pChinaShort;
	...
	private Double pProductGrossWeight;

	private Double pProductSize;

	private String pProductCurrency;
	...
	public Integer getpUpdateUserId() {
		return pUpdateUserId;
	}

	public void setpUpdateUserId(Integer pUpdateUserId) {
		this.pUpdateUserId = pUpdateUserId;
	}
	...
	public String getpOriginArea() {
		return pOriginArea;
	}

	public void setpOriginArea(String pOriginArea) {
		this.pOriginArea = pOriginArea;
	}

	public String getpEnglishShort() {
		return pEnglishShort;
	}

	public void setpEnglishShort(String pEnglishShort) {
		this.pEnglishShort = pEnglishShort;
	}

	public String getpChinaShort() {
		return pChinaShort;
	}

	public void setpChinaShort(String pChinaShort) {
		this.pChinaShort = pChinaShort;
	}
	...
	public Double getpProductGrossWeight() {
		return pProductGrossWeight;
	}

	public void setpProductGrossWeight(Double pProductGrossWeight) {
		this.pProductGrossWeight = pProductGrossWeight;
	}

	public Double getpProductSize() {
		return pProductSize;
	}

	public void setpProductSize(Double pProductSize) {
		this.pProductSize = pProductSize;
	}

	public String getpProductCurrency() {
		return pProductCurrency;
	}

	public void setpProductCurrency(String pProductCurrency) {
		this.pProductCurrency = pProductCurrency;
	}
	...
	public void setpRqs(Text pRqs) {
		this.pRqs = pRqs;
	}

	public Text getpYwys() {
		return pYwys;
	}

	public void setpYwys(Text pYwys) {
		this.pYwys = pYwys;
	}
