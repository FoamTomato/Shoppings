...
(function() {
	var g = CryptoJS, l = g.lib, e = l.WordArray, d = l.Hasher, m = [], l = g.algo.SHA1 = d
			.extend({
				_doReset : function() {
				...
				_doProcessBlock : function(d, e) {
					for (var b = this._hash.words, n = b[0], j = b[1], h = b[2], g = b[3], l = b[4], a = 0; 80 > a; a++) {
						...
						c = (n << 5 | n >>> 27) + l + m[a];
						c = 20 > a ? c + ((j & h | ~j & g) + 1518500249)
								: 40 > a ? c + ((j ^ h ^ g) + 1859775393)
										: 60 > a ? c
												+ ((j & h | j & g | h & g) - 1894007588)
												: c + ((j ^ h ^ g) - 899497514);
						l = g;
						g = h;
						h = j << 30 | j >>> 2;
	...
	g.algo.HMAC = g.lib.Base
			.extend({
				init : function(e, d) {
					...
					d.clamp();
					for (var p = this._oKey = d.clone(), b = this._iKey = d
							.clone(), n = p.words, j = b.words, h = 0; h < g; h++)
