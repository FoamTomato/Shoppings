...
public class ArticleController {
	...
	public @ResponseBody Map<String, Object> receiveGetArticleCategory(PageInformation pageInfo, Article searchVo){
	...
	public @ResponseBody int receiveSaveArticle(@RequestBody Article saveVo) throws IllegalAccessException, InvocationTargetException{
		return articleService.saveArticle(saveVo);
	}
	
	@RequestMapping(value = "/admin/receiveSetArticle")
	public @ResponseBody int receiveSetArticle(@RequestBody Article saveVo) throws IllegalAccessException, InvocationTargetException{
		return articleService.modArticle(saveVo);
	}
	
	@RequestMapping(value = "/admin/receiveDelArticle")
	public @ResponseBody int receiveDelArticle(@RequestBody int id) throws IllegalAccessException, InvocationTargetException{
