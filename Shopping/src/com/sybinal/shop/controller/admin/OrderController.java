...
public class OrderController {
	...
	@RequestMapping(value = "/order/select/list", method = RequestMethod.POST)
	@ResponseBody
	public Map<String,Object> orderManagelist() {
		User user=new User();
		user.setUserName(FLogisticsController.username());
		Map<String,Object>map=new HashMap<String,Object>();
		map.put("jurisdiction", userService.jurisdiction(user));
		map.put("logoutlist", logout.selectAll());
		return map;
	}
