...
public class Glogistics {
	...
	public String toString() {
		return "Glogistics [id=" + id + ", fids=" + fids + ", foldorder=" + foldorder + ", foldpurchase=" + foldpurchase
				+ ", fclientordercode=" + fclientordercode + ", fstore=" + fstore + ", fpaytime=" + fpaytime
				+ ", fcurrency=" + fcurrency + ", ftotalprice=" + ftotalprice + ", fchinashort=" + fchinashort
				+ ", ffirstname=" + ffirstname + ", flastname=" + flastname + ", fcountry=" + fcountry + ", fprovince="
				+ fprovince + ", fcity=" + fcity + ", fpostcode=" + fpostcode + ", femail=" + femail + ", ftelephone="
				+ ftelephone + ", faddress1=" + faddress1 + ", faddress2=" + faddress2 + ", faddress3=" + faddress3
				+ ", flogistics=" + flogistics + ", fenglishshort=" + fenglishshort + ", fchannel=" + fchannel
				+ ", fsheet=" + fsheet + ", fstatue=" + fstatue + ", ffreight=" + ffreight + ", fcustoms=" + fcustoms
				+ ", fweight=" + fweight + ", fremark=" + fremark + ", standby1=" + standby1 + ", standby2=" + standby2
				+ ", standby3=" + standby3 + ", standby4=" + standby4 + ", standby5=" + standby5 + ", standby6="
				+ standby6 + ", standby7=" + standby7 + ", standby8=" + standby8 + ", standby9=" + standby9 + "]";
	}
