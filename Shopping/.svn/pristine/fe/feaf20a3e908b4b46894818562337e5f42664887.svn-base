	...
	<div class="small-header transition animated fadeIn">
									...
									<form id="form_userInfo" name="form_userInfo"  method="POST">
										<div class="form-group col-lg-6">
					                        ...
					                        <div class="input-group date">
					                            <input name="updateTimeFrom" type="text" class="form-control" readonly="readonly" style="background-color: transparent;">
										...
										<div class="form-group col-lg-6">
											<label>至</label>
					                        <div class="input-group date">
					                            <input name="updateTimeTo" type="text" class="form-control" readonly="readonly" style="background-color: transparent;">
					                            <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
					                        </div>
										</div>	
										<div class="form-group col-lg-6">
											<label>分类名</label>
												<input type="text"  name="categoryName" 
													class="form-control" maxlength="50" placeholder="分类名" onchange="illegalChar(this)"/>
										</div>	
										<div class="form-group col-lg-6">
											<div class="text-right m-t-xs">
												<button id="search" class="btn btn-success" type="button"><strong>查询</strong></button>
											    <button id="reset" class="btn btn-success"  type="reset"><strong>重置</strong></button>
												<button id="new" onclick="resetId()" data-toggle="modal" data-target="#myModal" class="btn btn-success"  type="button"><strong>新增</strong></button>
									    	 </div>
										</div>	
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="hpanel">
					<div class="panel-body">
						<table id="articleCategoryInfoList" style="width: 100%;" class="table table-striped table-bordered table-hover"></table>
					</div>
				</div>
			</div>
		</div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form id="form_saveArticleCategory name="form_userInfo" action="" method="">
										...
										<div class="text-right m-t-xs">
												<button id="save" onclick="saveArticleCategory()" class="btn btn-success" style="margin-right: 5px;margin-top: 5px"
													type="button">
													<strong>保存</strong>
												</button>
