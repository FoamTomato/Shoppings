...
public class ArticleCategoryController {
	...
	public @ResponseBody Map<String, Object> receiveGetArticleCategory(PageInformation pageInfo, ArticleCategory searchVo){
	...
	public @ResponseBody ArticleCategory receiveUpdateArticleCategory(@RequestBody int id){
		return articleCategoryService.getArticleCategoryById(id);
	}
	
	@RequestMapping(value = "/admin/receiveSaveArticleCategory")
	public @ResponseBody Map<String, String> receiveSaveArticleCategory(@RequestBody ArticleCategory saveVo) throws IllegalAccessException, InvocationTargetException{
		return articleCategoryService.saveArticleCategory(saveVo);
	}
	
	@RequestMapping(value = "/admin/receiveSetArticleCategory")
	public @ResponseBody Map<String, String> receiveSetArticleCategory(@RequestBody ArticleCategory saveVo) throws IllegalAccessException, InvocationTargetException{
		return articleCategoryService.modArticleCategory(saveVo);
	}
	
	@RequestMapping(value = "/admin/receiveDelArticleCategory")
	public @ResponseBody Map<String, String> receiveDelArticleCategory(@RequestBody ArticleCategory delVo) throws IllegalAccessException, InvocationTargetException{
		return articleCategoryService.delArticleCategory(delVo);
	}
	@RequestMapping(value = "/admin/receiveAllCategory")
	public @ResponseBody List<ArticleCategory> receiveAllCategory(){
