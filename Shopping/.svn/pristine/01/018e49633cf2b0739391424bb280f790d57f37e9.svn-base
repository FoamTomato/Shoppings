...
public class ApiOrderServiceImpl implements ApiOrderService {
	...
	@Override
	public ApiResponseObject payOrder(Map<String,Object> mapReq) throws ApiServiceException {
		return httpClientTool.doPostJson(HttpClientTool.API_URL_ORDER_PAYMENT, mapReq);
	}
