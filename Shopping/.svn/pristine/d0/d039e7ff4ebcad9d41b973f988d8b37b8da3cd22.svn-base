...
public class DTfzyings {
	...
	public List<DTstock> getY() {
		return y;
	}

	public void setY(List<DTstock> y) {
		this.y = y;
	}
	...
	public String toString() {
		return "DTfzyings [id=" + id + ", fids=" + fids + ", fsku=" + fsku + ", fbrand=" + fbrand + ", fkind=" + fkind
				+ ", fkeys=" + fkeys + ", fbullet=" + fbullet + ", fintro=" + fintro + ", fcur=" + fcur + ", fprice="
				+ fprice + ", fcost=" + fcost + ", ffreight=" + ffreight + ", fdeclare=" + fdeclare + ", fshipid="
				+ fshipid + ", fquantity=" + fquantity + ", fitems=" + fitems + ", fweight=" + fweight + ", flength="
				+ flength + ", fwidth=" + fwidth + ", fheight=" + fheight + ", fbattery=" + fbattery + ", fspecial="
				+ fspecial + ", fstock=" + fstock + ", forigin=" + forigin + ", ffacturer=" + ffacturer + ", fnumber="
				+ fnumber + ", fdepartment=" + fdepartment + ", fmaterial=" + fmaterial + ", fmetal=" + fmetal
				+ ", fgem=" + fgem + ", fpackages=" + fpackages + ", fhscode=" + fhscode + ", fenglish=" + fenglish
				+ ", fchinese=" + fchinese + ", fsource=" + fsource + ", fmemo=" + fmemo + ", frs1=" + frs1 + ", frs2="
				+ frs2 + ", frs3=" + frs3 + ", frs4=" + frs4 + ", frs5=" + frs5 + ", frs6=" + frs6 + ", frs7=" + frs7
				+ ", frs8=" + frs8 + ", frs9=" + frs9 + ", frs10=" + frs10 + ", fpic=" + fpic + ", price1=" + price1
				+ ", price2=" + price2 + ", updateTime1=" + updateTime1 + ", updateTime2=" + updateTime2 + "]";
	}
