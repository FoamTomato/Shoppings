						...
						<form id="form_userInfo" name="form_userInfo" method="POST">
							<div class="row">
								<div class="form-group col-lg-6">
									<label>标题</label> 
									<input type="text" name="title"	class="form-control" maxlength="50" onchange="illegalChar(this)" />
								</div>
								<div class="form-group col-lg-6">
									<label>文章分类</label> 
									<input type="text" name="articleCategoryName" class="form-control" maxlength="50" placeholder="分类名" onchange="illegalChar(this)" />
								</div>
							</div>
							<div class="row">
								<div class="form-group col-lg-6">
									...
									<div class="input-group col-sm-10 date">
										<input name="updateTimeFrom" type="text" class="form-control" style="background-color: transparent;">
								...
								<div class="form-group col-lg-6">
									<label>至</label>
									<div class="input-group col-sm-10 date">
										<input name="updateTimeTo" type="text" class="form-control" style="background-color: transparent;">
										<span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
									</div>
								</div>
							</div>
	...
	$('#leftMenuArticle').addClass('active');
		...
		function openPostWindow(params) {
			/* 	var newWin = window.open(),
			 formStr = '';
			 formStr = '<form style="visibility:hidden;" method="POST" action="${pageContext.request.contextPath}/admin/receiveUpdateArticle?${_csrf.parameterName}=${_csrf.token}">' +
