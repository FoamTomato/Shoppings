...
public class ProductCategory {
	...
	public String toString() {
		return "ProductCategory [id=" + id + ", pid=" + pId + ", name=" + name + ", sortOrder=" + sortOrder + ", image="
				+ image + ", updateTime=" + updateTime + ", updateUserId=" + updateUserId + ", description="
				+ description + ", productList=" + productList + ", updateUserName=" + updateUserName + ", createTime="
				+ createTime + "]";
	}
