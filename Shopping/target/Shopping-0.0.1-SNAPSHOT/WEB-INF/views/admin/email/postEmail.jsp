										    ...
										    <el-aside :width="productlist!=null?'700px':'100%'">
										      <el-container style="height:620px">
											    <el-header style="float:left;height: auto;font-family: unset">
											    	...
											    	<h5>时间：{{timechange(detailsList.emailTimes)}}</h5><a v-if="detailsList.spare3 != null" style="color:green;margin:5px" @click="downlib()">附件下载</a>
											    </el-header>
		...
		var vm=new Vue({
			...
			methods:{
        	    ...
        	    posts(){
					...
					datas["host"]=this.fileRepose.substr(0,this.fileRepose.length-1)
					datas["port"]=this.fileRepose.substr(0,this.fileRepose.length-1)
